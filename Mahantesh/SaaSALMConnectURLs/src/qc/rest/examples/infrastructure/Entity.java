...
This automatically generated class is an example of how one can generate classes from an XSD via XJC to match JAXB standards.
...
When compiling this source file, one can "marshal" an object instance from the XML describing the object.
This process has many advantages, and is a form of serialization that is not language dependent. It is the recommended way of working with entities, though we suggest you customize your entity class with simpler accessors.
*/
 ...
 */
 ...
 public String getFieldValue(String fieldName){
	 ...
	 List<Field> fieldList = this.getFields().getField();
		for(Field field : fieldList){
			if(fieldName.equals(field.getName()))fieldValue =  field.getValue().get(0).toString();
		}
	 return fieldValue;
 }
}
