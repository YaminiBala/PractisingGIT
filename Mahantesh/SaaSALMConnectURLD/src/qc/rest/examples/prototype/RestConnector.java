...
public class RestConnector {
    ...
    public RestConnector init(Map<String, String> cookies,String URL, String host, String port, String domain, String project) {
    ...
    public String buildingUrl(String path) {
        return String.format("http://"+this.URL+"/"+ path);
    }
