...
public class EntityUpdater {
    ...
    public EntityUpdater(String almDomain, String almProject) {
        ...
        this.con = RestConnector.getInstance().init(new HashMap<String, String>(),Constants.URL, Constants.HOST, Constants.PORT, this.domain, this.project);
    ...
    public Response getInstanceId(String cycleid, String testid) throws Exception {
        ...
        requestHeaders.put("Content-Type", "application/xml");
        requestHeaders.put("Accept", "application/xml");
        Response XML1 = this.con.httpGet("http://" + Constants.URL+ "/qcbin/rest/domains/" + Constants.DOMAIN + "/projects/" + Constants.PROJECT + "/test-instances?query={cycle-id[" + cycleid + "];test-id[" + testid + "]}&fields=id", null, requestHeaders);
